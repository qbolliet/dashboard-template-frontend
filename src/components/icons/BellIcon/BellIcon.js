 ...
 * Represents alerts/notifications, used by the tabs example page and
 * reusable anywhere a generic notification glyph is needed.
 *
 ...
 * @returns {JSX.Element} The rendered bell icon SVG.
 */
const BellIcon = ({
    className = '',
    width = 16,
